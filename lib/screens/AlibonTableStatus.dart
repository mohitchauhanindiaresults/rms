...
class AlibonTableStatus extends StatefulWidget {
  @override
  _AlibonTableStatusState createState() => _AlibonTableStatusState();
}

class _AlibonTableStatusState extends State<AlibonTableStatus> {
  ...
  Future<void> fetchData() async {
    ...
    final response = await http.post(
      Uri.parse('https://abc.charumindworks.com/inventory/api/v1/tablereservationstatus/alibon'),
      body: {
